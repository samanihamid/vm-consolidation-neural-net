...
class NeuralNet
  ...
  @input_size = 784
  InputData.new(input_size: 100, hidden_nodes: 5, classes: 10)
  byebug
...
options[:classes] = 10 if options[:classes].nil?

options[:input_size] = 784 if options[:input_size].nil?
